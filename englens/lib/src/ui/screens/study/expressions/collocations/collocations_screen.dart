...
import 'package:englens/src/ui/screens/study/expressions/collocations/collocations_screen_viewmodel.dart';
...
class CollocationsScreen extends StatelessWidget {
  static const routeName = '/collocationsScreen';
  const CollocationsScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<CollocationsScreenViewmodel>(
      init: CollocationsScreenViewmodel(),
      builder: (controller) {
                ...
                SizedBox(
                  ...
                  child: ClipRRect(
                    ...
                    child: Hero(
                      ...
                      child: Image.asset(
                        'assets/images/expressions/collocations/$title.jpg',
                        fit: BoxFit.fill,
                      ),
                    ),
                  ),
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                Text(
                                    '${controller.collocationsList[index].lessons!.length} Lesson'),
                      ...
                      return InkWell(
                        onTap: () {
                          Get.toNamed(
                            ...
                            arguments: LessonDetailsScreenViewmodelArgs(
                              lessons:
                                  controller.collocationsList[index].lessons!,
                              lessonImage:
                        ...
                        child: Padding(
                          ...
                          child: _wordListByTopicItem(
                              controller.collocationsList[index].title, index),
                        ),
                      );
                    },
                    separatorBuilder: (context, index) => const SizedBox(),
                    itemCount: controller.collocationsList.length,
                  ),
                ),
              ],
            ),
