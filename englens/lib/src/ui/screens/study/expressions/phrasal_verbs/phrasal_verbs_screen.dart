...
import 'package:englens/src/ui/screens/study/expressions/phrasal_verbs/phrasal_verbs_screen_viewmodel.dart';
...
class PhrasalVerbsScreen extends StatelessWidget {
  static const routeName = '/phrasalVerbsScreen';

  const PhrasalVerbsScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<PhrasalVerbsScreenViewmodel>(
      init: PhrasalVerbsScreenViewmodel(),
      builder: (controller) {
                ...
                SizedBox(
                  ...
                  child: ClipRRect(
                    ...
                    child: Hero(
                      ...
                      child: Image.asset(
                        'assets/images/expressions/phrasal_verbs/$title.jpg',
                        fit: BoxFit.fill,
                      ),
                    ),
                  ),
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                Text(
                                    '${controller.phrasalVerbsList[index].lessons!.length} Lesson'),
                      ...
                      return InkWell(
                        onTap: () {
                          Get.toNamed(
                            ...
                            arguments: LessonDetailsScreenViewmodelArgs(
                              lessons:
                                  controller.phrasalVerbsList[index].lessons!,
                              lessonImage:
                        ...
                        child: Padding(
                          ...
                          child: _wordListByTopicItem(
                              controller.phrasalVerbsList[index].title, index),
                        ),
                      );
                    },
                    separatorBuilder: (context, index) => const SizedBox(),
                    itemCount: controller.phrasalVerbsList.length,
                  ),
                ),
              ],
            ),
