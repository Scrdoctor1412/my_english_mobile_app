        ...
        child: NavigationBar(
          ...
          destinations: [
            NavigationDestination(
              icon: Icon(
                Icons.home,
                color: controller.tabIndex == 0 ? Colors.white : Colors.black,
              ),
              label: 'Home',
            ),
            NavigationDestination(
              icon: Icon(
                Icons.school,
                color: controller.tabIndex == 1 ? Colors.white : Colors.black,
              ),
              label: 'Study',
            ),
            // NavigationDestination(
            ...
            NavigationDestination(
              icon: Icon(
                Icons.book,
                color: controller.tabIndex == 2 ? Colors.white : Colors.black,
              ),
              label: 'Handbook',
            ),
            NavigationDestination(
              icon: Icon(
                Icons.settings,
                color: controller.tabIndex == 3 ? Colors.white : Colors.black,
              ),
              label: 'Settings',
            ),
          ],
