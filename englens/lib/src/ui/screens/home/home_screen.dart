          ...
          children: [
            DrawerHeader(
              ...
              child: SizedBox(
                width: 150,
                height: 150,
                child: Image.asset('assets/icons/app_icon_color_black_2.png'),
              ),
            ),
            ListTile(
              leading: Icon(
          ...
          child: Column(
            ...
            children: [
              Expanded(
                child: Row(
                  children: [
                    Icon(Icons.folder_copy_outlined, color: Colors.orange),
                    const Spacer(),
                                ...
                                children: [
                                  SizedBox(
                                    ...
                                    child: CircularProgressIndicator(
                                      strokeWidth: 10,
                                      color: ThemePrimary.primaryOrange,
                                      backgroundColor: ThemePrimary.grey
                                          .withAlpha(50),
                              ...
                              Expanded(
                                child: ListView.separated(
                                  ...
                                  itemBuilder: (context, index) {
                                    return SizedBox(
                                      ...
                                      child: InkWell(
                                        ...
                                        child: EnglishCard(
                                          word:
                                              controller.listRandomWords[index],
                                        ),
                                      ),
                                    );
                                  },
                                  separatorBuilder: (context, index) =>
                                      SizedBox(width: 20),
                                  itemCount: controller.listRandomWords.length,
                                ),
                              ),
                            ],
                          ),
...
class RPSCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path_0.quadraticBezierTo(
      size.width * 0.9696944,
      size.height * 0.5217542,
      size.width * 0.8824074,
      size.height * 0.5218833,
    );
    path_0.cubicTo(
    ...
    path_0.quadraticBezierTo(
      size.width * 0.0347407,
      size.height * 0.5213167,
      size.width * -0.0002963,
      size.height * 0.4972750,
    );
    path_0.close();
    ...
    path_1.quadraticBezierTo(
      size.width * 0.8030093,
      size.height * 0.0001042,
      size.width * 0.7370370,
    ...
    path_1.quadraticBezierTo(
      size.width * 0.7681944,
      size.height * 0.2311042,
      size.width * 1.0018519,
      size.height * 0.2757417,
    );
