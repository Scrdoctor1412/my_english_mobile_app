...
class LeitnerDailyWordsScreen
    extends GetView<LeitnerDailyWordsScreenViewModel> {
    ...
    _body() {
      return CustomScrollView(
        slivers: [
          ...
          DecoratedSliver(
            decoration: BoxDecoration(color: Color(0xffebeeff)),
            sliver: SliverList.separated(
              itemBuilder: (context, index) => Padding(
                ...
                child: _leitnerItemRow(
                  ...
                  wordsCount: controller.leitnerItems[index].wordList!.length,
                ),
              ),
